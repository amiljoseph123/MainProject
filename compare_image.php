...
class CompareImages
{
    ...
    {
        /*returns array with mime type and if it's jpg or png. Returns false if it isn't jpg or png*/
        $mime = getimagesize($i);
...
// Example of usage
$comparator = new CompareImages();
$distance = $comparator->compare('F:\xampp\htdocs\Infantcare_main\images\o1.jpg', 'F:\xampp\htdocs\Infantcare_main\images\o5.jpg');
