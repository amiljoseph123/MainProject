    ...
    <section class="don-sec" id="donation">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="don-box">
                        <img src="donation_img/don/clothing.png" alt="img">
                        <h3>Clothes</h3>
                ...
                <div class="col-lg-4">
                    <div class="don-box">
                        <img src="donation_img/don/sneakers.png" alt="img">
                        <h3>Footware</h3>
                        <p>Lorem ipsum dolor sit amet consectetur.</p>
                        <a href="#contact" class="btn1">Donate Now</a>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="don-box">
                        <img src="donation_img/don/salary.png" alt="img">
                        <h3>Fund</h3>
                        <p>Lorem ipsum dolor sit amet consectetur.</p>
                        <a href="pay3.php" class="btn1">Donate Now</a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="don-box">
                        <img src="donation_img/don/gadgets.png" alt="img">
                        <h3>Gadgets</h3>
                        <p>Lorem ipsum dolor sit amet consectetur.</p>
                        <a href="#contact" class="btn1">Donate Now</a>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="don-box">
                        <img src="donation_img/don/book.png" alt="img">
                        <h3>Stationary</h3>
                        <p>Lorem ipsum dolor sit amet consectetur.</p>
                        <a href="#contact" class="btn1">Donate Now</a>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="don-box">
                        <img src="donation_img/don/shopping-bag.png" alt="img">
                        <h3>Food</h3>
                        <p>Lorem ipsum dolor sit amet consectetur.</p>
                        <a href="#contact" class="btn1">Donate Now</a>
                    </div>
