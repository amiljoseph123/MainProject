...
function sendemail_verify($email,$donationAmount)
{
    ...
    try {
        ...
        $mail->Username = 'infantcare@gmail.com'; // Your Gmail email address
        ...
        $mail->isHTML(true);
        $mail->Subject = 'Email from Infantcare';
        $name = $_POST['name'];
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mx-auto">
                         ...
                         <form class="custom-form donate-form" action="donation_process.php" method="POST" role="form">
                            ...
                            <div class="row">
                                ...
                                <!-- <div class="col-lg-3 col-md-6 col-6 form-check-group">
                                    <div class="form-check form-check-radio">
                                        <input class="form-check-input" type="radio" name="amount" id="amount">
...
<!-- 
                                                            <div class="col-lg-3 col-md-6 col-6 form-check-group">
                                <div class="form-check form-check-radio">
                                    <input class="form-check-input" type="radio" name="amount" id="amount10" value="10">
                                    <label class="form-check-label" for="amount10">
                                        10
                                    </label>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12 col-12 mt-2">
                                    ...
                                    <button type="submit" class="form-control mt-4"><a href="receipt.php">submit donation<a></button>
                                </div>
                            </div>
                        </form>  


                        <!-- <form class="custom-form donate-form" action="donation_process.php" method="get" role="form">
                        <input type="text" name="name" id="donation-name" class="form-control" placeholder="name" required>
<input type="email" name="email" id="donation-email" pattern="[^ @]*@[^ @]*" class="form-control" placeholder="email" required>
<input type="text" class="form-control" placeholder="Custom amount" aria-label="Username" aria-describedby="basic-addon1" name="amount">
