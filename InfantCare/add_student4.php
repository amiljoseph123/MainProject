...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="assets/images/favicon.ico" />
                    ...
                    <!-- <form action="add_student4.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
  ...
  function validateForm() {
        ...
        if (firstname.charAt(0) !== firstname.charAt(0).toUpperCase()) {
          alert("First letter of the first name must be capitalized");
          return false;
        }

        // Check if only letters are entered
        if (!/^[a-zA-Z]+$/.test(firstname)) {
          alert("Only letters are allowed in the first name");
          return false;
        }}
</script>
...
<form action="add_student4.php" method="post" enctype="multipart/form-data">
      <div class="form-group">
        <label for="exampleInputUsername1">First Name</label>
        <input type="text" class="form-control" id="firstname" name="firstname" required>
      ...
      document.getElementById('lastname').addEventListener('input', function() {
        ...
        if (lastname.charAt(0) !== lastname.charAt(0).toUpperCase()) {
          lastnameError.textContent = 'First letter must be capitalized';
        } else {
          lasstnameError.textContent = '';
        }
